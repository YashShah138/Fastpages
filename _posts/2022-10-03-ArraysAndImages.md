---
keywords: fastai
description: Changing Images to Different Formats and Displaying Metadata
title: Arrays and Images
toc: false
comments: false
categories: [Week-6]
image: images/MonaLisa.png
nb_path: _notebooks/2022-10-03-ArraysAndImages.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-10-03-ArraysAndImages.ipynb
-->
...
<h2 id="Image-Manipulation">Image Manipulation<a class="anchor-link" href="#Image-Manipulation"> </a></h2><p>Continue to work with Classes, Arrays, and 2D arrays.</p>
...
<span class="kd">public</span> <span class="kd">class</span> <span class="nc">Pics</span> <span class="p">{</span>
    ...
    <span class="kd">public</span> <span class="nf">Pics</span><span class="p">(</span><span class="n">String</span> <span class="n">name</span><span class="p">,</span> <span class="n">String</span> <span class="n">ext</span><span class="p">)</span> <span class="p">{</span>
        ...
        <span class="k">this</span><span class="p">.</span><span class="na">greyScaleFile</span> <span class="o">=</span> <span class="k">this</span><span class="p">.</span><span class="na">outDir</span> <span class="o">+</span> <span class="s">&quot;Grey_&quot;</span> <span class="o">+</span> <span class="n">name</span> <span class="o">+</span> <span class="s">&quot;.&quot;</span> <span class="o">+</span> <span class="n">ext</span><span class="p">;</span>
        <span class="k">this</span><span class="p">.</span><span class="na">redScaleFile</span> <span class="o">=</span> <span class="k">this</span><span class="p">.</span><span class="na">outDir</span> <span class="o">+</span> <span class="s">&quot;Red_&quot;</span> <span class="o">+</span> <span class="n">name</span> <span class="o">+</span> <span class="s">&quot;.&quot;</span> <span class="o">+</span> <span class="n">ext</span><span class="p">;</span>
        <span class="k">this</span><span class="p">.</span><span class="na">blueScaleFile</span> <span class="o">=</span> <span class="k">this</span><span class="p">.</span><span class="na">outDir</span> <span class="o">+</span> <span class="s">&quot;Blue_&quot;</span> <span class="o">+</span> <span class="n">name</span> <span class="o">+</span> <span class="s">&quot;.&quot;</span> <span class="o">+</span> <span class="n">ext</span><span class="p">;</span>
        <span class="k">this</span><span class="p">.</span><span class="na">greenScaleFile</span> <span class="o">=</span> <span class="k">this</span><span class="p">.</span><span class="na">outDir</span> <span class="o">+</span> <span class="s">&quot;Green_&quot;</span> <span class="o">+</span> <span class="n">name</span> <span class="o">+</span> <span class="s">&quot;.&quot;</span> <span class="o">+</span> <span class="n">ext</span><span class="p">;</span>
    ...
    <span class="kd">public</span> <span class="kd">static</span> <span class="kt">void</span> <span class="nf">main</span><span class="p">(</span><span class="n">String</span><span class="o">[]</span> <span class="n">args</span><span class="p">)</span> <span class="kd">throws</span> <span class="n">IOException</span> <span class="p">{</span>
        <span class="n">Pics</span> <span class="n">ascii</span> <span class="o">=</span> <span class="k">new</span> <span class="n">Pics</span><span class="p">(</span><span class="s">&quot;Java&quot;</span><span class="p">,</span> <span class="s">&quot;png&quot;</span><span class="p">);</span>
        ...
        <span class="n">Pics</span> <span class="n">grey</span> <span class="o">=</span> <span class="k">new</span> <span class="n">Pics</span><span class="p">(</span><span class="s">&quot;Java&quot;</span><span class="p">,</span> <span class="s">&quot;png&quot;</span><span class="p">);</span>
        <span class="n">grey</span><span class="p">.</span><span class="na">greyScale</span><span class="p">();</span>

        <span class="n">Pics</span> <span class="n">red</span> <span class="o">=</span> <span class="k">new</span> <span class="n">Pics</span><span class="p">(</span><span class="s">&quot;Java&quot;</span><span class="p">,</span> <span class="s">&quot;png&quot;</span><span class="p">);</span>
        <span class="n">red</span><span class="p">.</span><span class="na">redScale</span><span class="p">();</span>
        
        <span class="n">Pics</span> <span class="n">green</span> <span class="o">=</span> <span class="k">new</span> <span class="n">Pics</span><span class="p">(</span><span class="s">&quot;Java&quot;</span><span class="p">,</span> <span class="s">&quot;png&quot;</span><span class="p">);</span>
        <span class="n">green</span><span class="p">.</span><span class="na">greenScale</span><span class="p">();</span>

        <span class="n">Pics</span> <span class="n">blue</span> <span class="o">=</span> <span class="k">new</span> <span class="n">Pics</span><span class="p">(</span><span class="s">&quot;Java&quot;</span><span class="p">,</span> <span class="s">&quot;png&quot;</span><span class="p">);</span>
...
<pre>Original: 227380 389x413  images/MonaLisa.png
Scaled: 23777 128x136  images/tmp/MonaLisa.png
</pre>
</div>
</div>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>ASCII: <a href="https://github.com/YashShah138/Fastpages/blob/master/_notebooks/images/tmp/MonaLisa.txt">https://github.com/YashShah138/Fastpages/blob/master/_notebooks/images/tmp/MonaLisa.txt</a></p>
<p><img src="https://github.com/YashShah138/Fastpages/blob/master/_notebooks/images/tmp/MonaLisa.txt" alt="ASCII"></p>
<p><img src="https://github.com/YashShah138/Fastpages/blob/master/_notebooks/images/tmp/Grey_MonaLisa.png" alt="Grey"></p>
<p><img src="https://github.com/YashShah138/Fastpages/blob/master/_notebooks/images/tmp/Red_MonaLisa.png" alt="Red"></p>
<p><img src="https://github.com/YashShah138/Fastpages/blob/master/_notebooks/images/tmp/Blue_MonaLisa.png" alt="Blue"></p>
<p><img src="https://github.com/YashShah138/Fastpages/blob/master/_notebooks/images/tmp/Green_MonaLisa.png" alt="Green"></p>
